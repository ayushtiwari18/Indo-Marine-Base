...
import RoutePlanning from "@/components/RoutePlanning"; // Import the new component
...
const Visualization = () => {
  ...
  // Sample data for charts - keeping the same data
  ...
  const handleFilterChange = (filters) => setMapFilters(filters);
  const handleSearch = (query) => console.log("Searching for:", query);
  const handleExport = (format) => alert(`Exporting data as ${format}...`);
  const handleRefresh = () => {
    setIsRefreshing(true);
    setTimeout(() => {
  ...
  const handleRouteUpdate = (route) => console.log("Route updated:", route);
    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        >
          ...
          <div ref={controlsRef} className="flex items-center gap-3 flex-wrap">
            <Select defaultValue="2024">
              <SelectTrigger className="w-28 lg:w-32 bg-slate-800/50 border-cyan-500/20 text-slate-200">
                <SelectValue />
              </SelectTrigger>
            ...
            <Button className="bg-slate-800/50 hover:bg-slate-700/70 text-cyan-300 border-cyan-500/30 hover:border-cyan-400/50 px-3 lg:px-4">
        ...
        <Tabs defaultValue="interactive" className="w-full" ref={tabsRef}>
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 bg-slate-800/50 border border-cyan-500/20 h-auto p-1">
            <TabsTrigger
              value="interactive"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-blue-500 data-[state=active]:text-white text-slate-300 hover:text-cyan-300 text-xs lg:text-sm py-2"
            >
              <span className="hidden sm:inline">Interactive </span>Map
            </TabsTrigger>
            <TabsTrigger value="routes" className="...">
              <Route className="h-4 w-4 mr-1 sm:mr-2" />
              <span className="hidden sm:inline">Route </span>Planning
            </TabsTrigger>
            <TabsTrigger
              value="maps"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-blue-500 data-[state=active]:text-white text-slate-300 hover:text-cyan-300 text-xs lg:text-sm py-2"
                ...
                <div className="dashboard-card h-full">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <h3 className="text-xl lg:text-2xl font-semibold text-white flex items-center gap-3">
                      <Globe className="h-5 w-5 lg:h-6 lg:w-6 text-cyan-400" />
                  ...
                  <div className="rounded-xl overflow-hidden border border-cyan-500/20 w-full">
                    <InteractiveMap
...
<TabsContent value="routes" className="mt-6">
  <RoutePlanning userRole={userRole} />
</TabsContent>
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between mb-3 lg:mb-4">
                    <div
                      className={`w-8 h-8 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl bg-gradient-to-br ${
                        stat.color === "cyan"
                    ...
                    <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-cyan-400 rounded-full animate-pulse"></div>
                  </div>
                  <div className="space-y-1">
                    <div className="flex items-baseline gap-1">
                      <span className="text-xl lg:text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                        {isRefreshing ? "~" : stat.value}
                      </span>
                      <span className="text-sm lg:text-xl font-bold text-cyan-400">
                        {stat.unit}
                      </span>
                    </div>
          ...
          <TabsContent value="maps" className="space-y-6 mt-6">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              >
                <h3 className="text-xl lg:text-2xl font-semibold text-white flex items-center gap-3 mb-6">
                  <Map className="h-5 w-5 lg:h-6 lg:w-6 text-cyan-400" />
                  Temperature Heatmap
                </h3>
                <div className="rounded-xl overflow-hidden border border-cyan-500/20 w-full">
                  <TemperatureHeatMap height="h-48 sm:h-64" />
                </div>
                <div className="mt-4 lg:mt-6 flex justify-between text-sm text-slate-300">
                  <span>Min: 24°C</span>
              ...
              >
                <h3 className="text-xl lg:text-2xl font-semibold text-white flex items-center gap-3 mb-6">
                  <Fish className="h-5 w-5 lg:h-6 lg:w-6 text-blue-400" />
                  Biodiversity Hotspots
                </h3>
                <div className="rounded-xl overflow-hidden border border-cyan-500/20 w-full">
                  <BiodiversityMap height="h-48 sm:h-64" />
                </div>
                <div className="mt-4 lg:mt-6 flex justify-between text-sm text-slate-300">
                  <span>Low</span>
                  <span>Moderate</span>
            ...
            >
              ...
              <div className="rounded-xl overflow-hidden border border-cyan-500/20 w-full">
                <OceanParametersMap height="h-64 lg:h-80" />
              </div>
              <div className="mt-6 grid gap-4 lg:gap-6 grid-cols-1 sm:grid-cols-3">
          ...
          {/* Biodiversity Tab */}
          <TabsContent value="biodiversity" className="space-y-6 mt-6">
            <div
              className="dashboard-card"
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 lg:gap-4 flex-wrap">
                  ...
                  >
                    <SelectTrigger className="w-32 lg:w-40 bg-slate-800/50 border-cyan-500/20 text-slate-200">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-slate-900 border-cyan-500/20">
                      <SelectItem
              ...
              <div className="w-full h-64 lg:h-80 mb-6">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart
