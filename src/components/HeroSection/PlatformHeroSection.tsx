      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
            Integrate heterogeneous marine datasets from oceanography, taxonomy, morphology, and molecular biology 
            into a single intelligent platform for comprehensive ecosystem analysis.
          </p>
              ...
              <div className="relative bg-card rounded-lg p-6 shadow-wave">
                <div className="aspect-video bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-slate-800 dark:to-slate-700 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-foreground mb-2">Oceanographic Data Dashboard</h4>
                    <p className="text-sm text-muted-foreground">Real-time species identification & monitoring</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-card rounded-lg p-6 shadow-wave">
                <div className="aspect-video bg-gradient-to-br from-slate-800 to-slate-700 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-foreground mb-2">eDNA Analysis Interface</h4>
                    <p className="text-sm text-muted-foreground">Molecular biodiversity visualization</p>
                  </div>
                </div>
              </div>
            </div>
