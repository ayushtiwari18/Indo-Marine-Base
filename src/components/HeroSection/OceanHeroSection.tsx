    ...
    >
      ...
      <div className="relative z-20 text-center px-4 max-w-6xl mx-auto">
        ...
        <div className="w-full max-w-4xl mx-auto h-32 relative mb-8">
          ...
          <div className="absolute inset-x-32 top-4 bg-gradient-to-r from-transparent via-blue-400 to-transparent h-[3px] w-2/4 blur-sm animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          Empowering marine biodiversity research through AI-driven oceanographic, 
          fisheries, and molecular data integration for sustainable ocean management.
        </p>
