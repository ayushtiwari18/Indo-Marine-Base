        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-6">
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                <CardTitle>Access Level Comparison</CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span>Used: {stat.value.toLocaleString()}</span>
                          <span>Limit: {stat.limit.toLocaleString()}</span>
                        </div>
                        <Progress
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-blue-50 rounded-lg">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <div className="text-slate-600">Requests Made</div>
                          ...
                          <div>
                            <div className="text-slate-600">Reset Time</div>
                            <div className="font-bold">
                              {new Date(
                          ...
                          <div>
                            <div className="text-slate-600">Usage Rate</div>
                            <div className="font-bold">
                              {(
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center p-3 bg-slate-50 rounded">
                          ...
                          <Badge variant="outline">847 requests</Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-slate-50 rounded">
                          <span className="text-sm">Most Used Endpoint</span>
                          <Badge variant="outline">/species/search</Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-slate-50 rounded">
                          <span className="text-sm">Avg Response Time</span>
                          <Badge variant="outline">0.24s</Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-slate-50 rounded">
        ...
        <TabsContent value="permissions" className="space-y-6">
          <Card className="shadow-lg border-0">
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-4">
                  <h4 className="font-semibold">Endpoint Access</h4>
                  <div className="space-y-3">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Switch
                            ...
                            disabled={key === "admin_access"} // Some permissions might be locked
                          />
                        </div>
                      </div>
                    ))}
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold">Feature Limits</h4>
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <Badge variant="outline">2.4 GB / 5 GB</Badge>
                      </div>
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <Badge variant="outline">234 / 1000</Badge>
                      </div>
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      <div className="font-medium">Request Signing</div>
                      <div className="text-sm text-slate-600">
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      <div className="font-medium">Failed Login Alerts</div>
                      <div className="text-sm text-slate-600">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center p-3 bg-green-50 border border-green-200 rounded">
                    <div>
                      <div className="font-mono">203.45.67.89</div>
                      <div className="text-sm text-slate-600">
                        Office Network
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center p-3 bg-slate-50 rounded">
                    <div>
                      <div className="font-mono">45.123.78.90</div>
                      <div className="text-sm text-slate-600">Home Office</div>
                    </div>
                    <div className="flex gap-2">
                      <Badge variant="outline">Inactive</Badge>
                      <Button size="sm" variant="outline">
